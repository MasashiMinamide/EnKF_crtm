...
while [[ $DATE -le $END_DATE_STAGE0 ]]; do
   ...
   export FILE=${FC_DIR}/${DATE}00/wrfout_d${DOMAIN}_${FILE_DATE}
   ...
   #./gen_be_stage0_wrf.exe ${BE_METHOD} ${FCST_TIME} $NE $FILE1 5 > gen_be_stage0_wrf.${FCST_TIME}.log 2>&1
   ...
   echo $DATE $FILE ${FC_DIR}/${NEXT_DATE}00/wrfout_d${DOMAIN}_${FILE_DATE}
